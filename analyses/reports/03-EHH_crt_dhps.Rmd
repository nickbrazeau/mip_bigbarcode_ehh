...
bifurmap <- crtdhps_sub %>%
  ...
  dplyr::mutate(nucleotides = T,
                left = 11, # marker here is 11
                right = 11, # max here would be 66-11
                max.haps = 2,
                palette = "RdBu",
                reverse = FALSE,
                relabel = NULL)
...
bifurmap <- crtdhps_sub %>%
  ...
  dplyr::rename(hh = haplohh,
                ...
                focal = cM_Pos) %>%
  dplyr::mutate(nucleotides = T,
                left = 13, # marker here is 13
                right = 12, # max here would be 36-23 for marker
                max.haps = 2,
                palette = "RdBu",
                reverse = FALSE,
                relabel = NULL)
...
bifurmap <- crtdhps_sub %>%
  ...
  dplyr::mutate(nucleotides = T,
                left = 13, # marker here is 13
                right = 11, # max here would be 36-23 for marker
                max.haps = 2,
                palette = "RdBu",
                reverse = FALSE,
                relabel = NULL)
