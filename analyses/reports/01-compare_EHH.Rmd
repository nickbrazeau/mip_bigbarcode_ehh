...
library(tidyverse)
library(gridExtra)
load("~/Documents/GitHub/mip_bigbarcode_ehh/data/derived/drugregions_sub.rda")
load("~/Documents/GitHub/mip_bigbarcode_ehh/data/derived/drug_res_nopopstructure.rda")
mipbb_dr_panel_vcfR <- vcfR::read.vcfR(file = "~/Documents/GitHub/mip_bigbarcode_ehh/data/polarized_mipbi_bigbarcode.vcf.bgz")
